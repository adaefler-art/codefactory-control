...
var require_fast_content_type_parse = __commonJS({
  "node_modules/@octokit/core/node_modules/fast-content-type-parse/index.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports.default = { parse: parse4, safeParse: safeParse4 };
...
// node_modules/@octokit/plugin-retry/node_modules/bottleneck/light.js
var require_light = __commonJS({
  "node_modules/@octokit/plugin-retry/node_modules/bottleneck/light.js"(exports2, module2) {
      ...
      LocalDatastore = class LocalDatastore {
        ...
        async __register__(index, weight, expiration) {
          ...
          if (this.conditionsCheck(weight)) {
            ...
            wait3 = Math.max(this._nextRequest - now, 0);
            this._nextRequest = now + wait3 + this.storeOptions.minTime;
            return {
              success: true,
              wait: wait3,
        ...
        class Bottleneck3 {
          ...
          _run(index, job, wait3) {
            ...
            return this._scheduled[index] = {
              ...
              }, wait3 + job.options.expiration) : void 0,
              job
            };
          }
          _drainOne(capacity) {
            return this._registerLock.schedule(() => {
              ...
              return this._store.__register__(index, options.weight, options.expiration).then(({ success, wait: wait3, reservoir }) => {
                var empty;
...
// node_modules/@octokit/plugin-throttling/node_modules/bottleneck/light.js
var require_light2 = __commonJS({
  "node_modules/@octokit/plugin-throttling/node_modules/bottleneck/light.js"(exports2, module2) {
    (function(global2, factory) {
      typeof exports2 === "object" && typeof module2 !== "undefined" ? module2.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global2.Bottleneck = factory();
    })(exports2, (function() {
      "use strict";
...
// node_modules/@octokit/app/node_modules/fast-content-type-parse/index.js
var require_fast_content_type_parse2 = __commonJS({
  "node_modules/@octokit/app/node_modules/fast-content-type-parse/index.js"(exports2, module2) {
    "use strict";
    var NullObject = function NullObject2() {
    };
    NullObject.prototype = /* @__PURE__ */ Object.create(null);
...
// node_modules/@octokit/oauth-app/node_modules/fast-content-type-parse/index.js
var require_fast_content_type_parse3 = __commonJS({
  "node_modules/@octokit/oauth-app/node_modules/fast-content-type-parse/index.js"(exports2, module2) {
    "use strict";
    var NullObject = function NullObject2() {
    };
    NullObject.prototype = /* @__PURE__ */ Object.create(null);
...
// infra/lambdas/afu9_pr_creator.ts
var afu9_pr_creator_exports = {};
__export(afu9_pr_creator_exports, {
  handler: () => handler2
});
module.exports = __toCommonJS(afu9_pr_creator_exports);
...
function addHook(state, kind, name, hook11) {
  const orig = hook11;
  if (!state.registry[name]) {
    state.registry[name] = [];
  }
  if (kind === "before") {
    hook11 = (method, options) => {
...
function bindApi(hook11, state, name) {
  const removeHookRef = bindable(removeHook, null).apply(
    null,
    name ? [state, name] : [state]
  );
  hook11.api = { remove: removeHookRef };
  hook11.remove = removeHookRef;
  ["before", "error", "after", "wrap"].forEach((kind) => {
    const args = name ? [state, kind, name] : [state, kind];
    hook11[kind] = hook11.api[kind] = bindable(addHook, null).apply(null, args);
  });
}
function Singular() {
...
function Collection() {
  ...
  const hook11 = register.bind(null, state);
  bindApi(hook11, state);
  return hook11;
}
...
var Octokit = class {
  ...
  constructor(options = {}) {
    const hook11 = new before_after_hook_default.Collection();
    const requestDefaults = {
      baseUrl: request.endpoint.DEFAULTS.baseUrl,
      headers: {},
      request: Object.assign({}, options.request, {
        // @ts-ignore internal usage only, no need to type
        hook: hook11.bind(null, "request")
      }),
      mediaType: {
        previews: [],
        format: ""
    ...
    if (!options.authStrategy) {
      if (!options.auth) {
        ...
        const auth11 = createTokenAuth(options.auth);
        hook11.wrap("request", auth11.hook);
        this.auth = auth11;
      }
    } else {
      const { authStrategy, ...otherOptions } = options;
      const auth11 = authStrategy(
        Object.assign(
          {
...
async function wrapRequest(state, octokit, request4, options) {
  ...
  return limiter.schedule(
    requestWithGraphqlErrorHandling.bind(null, state, octokit, request4),
    options
  );
}
...
var import_light2 = __toESM(require_light2(), 1);
var VERSION8 = "0.0.0-development";
var noop2 = () => Promise.resolve();
function wrapRequest2(state, request4, options) {
...
async function doRequest(state, request4, options) {
  ...
  const req = (isAuth ? state.auth : state.global).key(state.id).schedule(jobOptions, request4, options);
  if (isGraphQL) {
    const res = await req;
...
var userAgent2 = `octokit-endpoint.js/${VERSION9} ${getUserAgent2()}`;
var DEFAULTS2 = {
  method: "GET",
  baseUrl: "https://api.github.com",
  headers: {
...
// node_modules/@octokit/app/node_modules/@octokit/oauth-methods/dist-bundle/index.js
...
async function exchangeWebFlowCode(options) {
  const request4 = options.request || request2;
...
async function resetToken(options) {
  const request4 = options.request || request2;
  const auth11 = btoa(`${options.clientId}:${options.clientSecret}`);
  const response = await request4(
    "PATCH /applications/{client_id}/token",
    {
      headers: {
        authorization: `basic ${auth11}`
      },
      client_id: options.clientId,
      access_token: options.token
    }
...
// node_modules/@octokit/app/node_modules/@octokit/auth-oauth-device/dist-bundle/index.js
...
async function hook2(state, request4, route, parameters) {
...
function createOAuthDeviceAuth(options) {
  const requestWithDefaults = options.request || request2.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-device.js/${VERSION11} ${getUserAgent2()}`
    }
  });
...
// node_modules/@octokit/app/node_modules/@octokit/auth-oauth-user/dist-bundle/index.js
...
function createOAuthUserAuth({
  ...
  clientSecret,
  clientType = "oauth-app",
  request: request4 = request2.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-app.js/${VERSION12} ${getUserAgent2()}`
    }
  }),
  onTokenCreated,
  ...strategyOptions
...
// node_modules/@octokit/app/node_modules/@octokit/auth-oauth-app/dist-bundle/index.js
...
async function hook4(state, request22, route, parameters) {
  ...
  try {
    ...
    error.message = `[@octokit/auth-oauth-app] "${endpoint4.method} ${endpoint4.url}" does not support clientId/clientSecret basic authentication.`;
    throw error;
  }
}
  ...
  const state = Object.assign(
    {
      request: request2.defaults({
        headers: {
          "user-agent": `octokit-auth-oauth-app.js/${VERSION13} ${getUserAgent2()}`
        }
      }),
      clientType: "oauth-app"
    },
...
// node_modules/@octokit/app/node_modules/universal-github-app-jwt/lib/utils.js
...
// node_modules/@octokit/app/node_modules/universal-github-app-jwt/lib/crypto-node.js
...
// node_modules/@octokit/app/node_modules/universal-github-app-jwt/lib/get-token.js
...
// node_modules/@octokit/app/node_modules/universal-github-app-jwt/index.js
...
// node_modules/@octokit/app/node_modules/toad-cache/dist/toad-cache.mjs
var LruObject = class {
...
// node_modules/@octokit/app/node_modules/@octokit/auth-app/dist-node/index.js
...
async function hook5(state, request4, route, parameters) {
...
function createAppAuth(options) {
  ...
  const request4 = options.request || request2.defaults({
    headers: {
      "user-agent": `octokit-auth-app.js/${VERSION14} ${getUserAgent2()}`
    }
  });
  const state = Object.assign(
    {
...
var userAgent3 = `octokit-endpoint.js/${VERSION15} ${getUserAgent3()}`;
var DEFAULTS3 = {
  method: "GET",
  baseUrl: "https://api.github.com",
  headers: {
...
var defaults_default3 = {
  headers: {
    "user-agent": `octokit-request.js/${VERSION16} ${getUserAgent3()}`
  }
};
...
// node_modules/@octokit/oauth-app/node_modules/@octokit/oauth-authorization-url/dist-src/index.js
...
// node_modules/@octokit/oauth-app/node_modules/@octokit/oauth-methods/dist-bundle/index.js
function requestToOAuthBaseUrl2(request4) {
  const endpointDefaults = request4.endpoint.DEFAULTS;
  return /^https:\/\/(api\.)?github\.com$/.test(endpointDefaults.baseUrl) ? "https://github.com" : endpointDefaults.baseUrl.replace("/api/v3", "");
}
async function oauthRequest2(request4, route, parameters) {
  const withOAuthParameters = {
    baseUrl: requestToOAuthBaseUrl2(request4),
    headers: {
      accept: "application/json"
    },
    ...parameters
...
function getWebFlowAuthorizationUrl({
  ...
  const baseUrl = requestToOAuthBaseUrl2(request4);
...
async function exchangeWebFlowCode2(options) {
  ...
  const response = await oauthRequest2(
    request4,
    "POST /login/oauth/access_token",
    {
      client_id: options.clientId,
  ...
  if (options.clientType === "github-app") {
    if ("refresh_token" in response.data) {
      const apiTimeInMs = new Date(response.headers.date).getTime();
      authentication.refreshToken = response.data.refresh_token, authentication.expiresAt = toTimestamp4(
        apiTimeInMs,
        response.data.expires_in
      ), authentication.refreshTokenExpiresAt = toTimestamp4(
        apiTimeInMs,
        response.data.refresh_token_expires_in
      );
    }
...
function toTimestamp4(apiTimeInMs, expirationInSeconds) {
  return new Date(apiTimeInMs + expirationInSeconds * 1e3).toISOString();
}
async function createDeviceCode2(options) {
  ...
  return oauthRequest2(request4, "POST /login/device/code", parameters);
}
async function exchangeDeviceCode2(options) {
  ...
  if (options.clientType === "github-app") {
    if ("refresh_token" in response.data) {
      const apiTimeInMs = new Date(response.headers.date).getTime();
      authentication.refreshToken = response.data.refresh_token, authentication.expiresAt = toTimestamp22(
        apiTimeInMs,
        response.data.expires_in
      ), authentication.refreshTokenExpiresAt = toTimestamp22(
        apiTimeInMs,
        response.data.refresh_token_expires_in
      );
    }
...
function toTimestamp22(apiTimeInMs, expirationInSeconds) {
  return new Date(apiTimeInMs + expirationInSeconds * 1e3).toISOString();
}
...
async function refreshToken2(options) {
  ...
  const authentication = {
    ...
    token: response.data.access_token,
    refreshToken: response.data.refresh_token,
    expiresAt: toTimestamp32(apiTimeInMs, response.data.expires_in),
    refreshTokenExpiresAt: toTimestamp32(
      apiTimeInMs,
      response.data.refresh_token_expires_in
    )
  };
...
function toTimestamp32(apiTimeInMs, expirationInSeconds) {
  return new Date(apiTimeInMs + expirationInSeconds * 1e3).toISOString();
}
...
// node_modules/@octokit/oauth-app/node_modules/@octokit/auth-oauth-device/dist-bundle/index.js
async function getOAuthAccessToken2(state, options) {
  const cachedAuthentication = getCachedAuthentication2(state, options.auth);
  if (cachedAuthentication) return cachedAuthentication;
  const { data: verification } = await createDeviceCode2({
    clientType: state.clientType,
    clientId: state.clientId,
    request: options.request || state.request,
    // @ts-expect-error the extra code to make TS happy is not worth it
  ...
  await state.onVerification(verification);
  const authentication = await waitForAccessToken2(
    options.request || state.request,
    state.clientId,
    state.clientType,
    verification
...
function getCachedAuthentication2(state, auth22) {
  if (auth22.refresh === true) return false;
  if (!state.authentication) return false;
  if (state.clientType === "github-app") {
    return state.authentication;
...
async function wait2(seconds) {
  await new Promise((resolve) => setTimeout(resolve, seconds * 1e3));
}
async function waitForAccessToken2(request4, clientId, clientType, verification) {
  try {
    const options = {
      clientId,
      request: request4,
    ...
    const { authentication } = clientType === "oauth-app" ? await exchangeDeviceCode2({
      ...options,
      clientType: "oauth-app"
    }) : await exchangeDeviceCode2({
      ...options,
      clientType: "github-app"
    });
    return {
    ...
    const errorType = error.response.data.error;
    if (errorType === "authorization_pending") {
      await wait2(verification.interval);
      return waitForAccessToken2(request4, clientId, clientType, verification);
    }
    if (errorType === "slow_down") {
      await wait2(verification.interval + 7);
      return waitForAccessToken2(request4, clientId, clientType, verification);
    }
    throw error;
  }
...
async function auth6(state, authOptions) {
  return getOAuthAccessToken2(state, {
    auth: authOptions
  });
}
async function hook6(state, request4, route, parameters) {
  ...
  const { token } = await getOAuthAccessToken2(state, {
    request: request4,
    auth: { type: "oauth" }
  });
  endpoint4.headers.authorization = `token ${token}`;
...
function createOAuthDeviceAuth2(options) {
  const requestWithDefaults = options.request || request3.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-device.js/${VERSION17} ${getUserAgent3()}`
    }
  });
  const { request: request4 = requestWithDefaults, ...otherOptions } = options;
  const state = options.clientType === "github-app" ? {
...
// node_modules/@octokit/oauth-app/node_modules/@octokit/auth-oauth-user/dist-bundle/index.js
var VERSION18 = "0.0.0-development";
async function getAuthentication2(state) {
  if ("code" in state.strategyOptions) {
    const { authentication } = await exchangeWebFlowCode2({
      clientId: state.clientId,
      clientSecret: state.clientSecret,
      clientType: state.clientType,
      onTokenCreated: state.onTokenCreated,
  ...
  if ("onVerification" in state.strategyOptions) {
    const deviceAuth = createOAuthDeviceAuth2({
      clientType: state.clientType,
      clientId: state.clientId,
      onTokenCreated: state.onTokenCreated,
      ...state.strategyOptions,
...
async function auth7(state, options = {}) {
  if (!state.authentication) {
    state.authentication = state.clientType === "oauth-app" ? await getAuthentication2(state) : await getAuthentication2(state);
  }
  if (state.authentication.invalid) {
    throw new Error("[@octokit/auth-oauth-user] Token is invalid");
  }
  ...
  if ("expiresAt" in currentAuthentication) {
    if (options.type === "refresh" || new Date(currentAuthentication.expiresAt) < /* @__PURE__ */ new Date()) {
      const { authentication } = await refreshToken2({
        clientType: "github-app",
        clientId: state.clientId,
        clientSecret: state.clientSecret,
        refreshToken: currentAuthentication.refreshToken,
  ...
  if (options.type === "check" || options.type === "reset") {
    const method = options.type === "check" ? checkToken2 : resetToken2;
    try {
      const { authentication } = await method({
        // @ts-expect-error making TS happy would require unnecessary code so no
        clientType: state.clientType,
  ...
  if (options.type === "delete" || options.type === "deleteAuthorization") {
    const method = options.type === "delete" ? deleteToken2 : deleteAuthorization2;
    try {
      await method({
        // @ts-expect-error making TS happy would require unnecessary code so no
        clientType: state.clientType,
...
var ROUTES_REQUIRING_BASIC_AUTH2 = /\/applications\/[^/]+\/(token|grant)s?/;
function requiresBasicAuth2(url) {
  return url && ROUTES_REQUIRING_BASIC_AUTH2.test(url);
}
async function hook7(state, request4, route, parameters = {}) {
  const endpoint4 = request4.endpoint.merge(
    route,
    parameters
  );
  ...
  if (requiresBasicAuth2(endpoint4.url)) {
    const credentials = btoa(`${state.clientId}:${state.clientSecret}`);
    endpoint4.headers.authorization = `basic ${credentials}`;
    return request4(endpoint4);
  }
  const { token } = state.clientType === "oauth-app" ? await auth7({ ...state, request: request4 }) : await auth7({ ...state, request: request4 });
  endpoint4.headers.authorization = "token " + token;
  return request4(endpoint4);
}
function createOAuthUserAuth2({
  ...
  request: request4 = request3.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-app.js/${VERSION18} ${getUserAgent3()}`
    }
  }),
  onTokenCreated,
  ...strategyOptions
  ...
  return Object.assign(auth7.bind(null, state), {
    // @ts-expect-error not worth the extra code needed to appease TS
    hook: hook7.bind(null, state)
  });
}
createOAuthUserAuth2.VERSION = VERSION18;

// node_modules/@octokit/oauth-app/node_modules/@octokit/auth-oauth-app/dist-bundle/index.js
async function auth8(state, authOptions) {
  if (authOptions.type === "oauth-app") {
    return {
      type: "oauth-app",
      clientId: state.clientId,
...
async function hook8(state, request22, route, parameters) {
  let endpoint4 = request22.endpoint.merge(
    route,
    parameters
  );
  ...
  if (state.clientType === "github-app" && !requiresBasicAuth2(endpoint4.url)) {
    throw new Error(
      `[@octokit/auth-oauth-app] GitHub Apps cannot use their client ID/secret for basic authentication for endpoints other than "/applications/{client_id}/**". "${endpoint4.method} ${endpoint4.url}" is not supported.`
    );
  }
...
function createOAuthAppAuth2(options) {
  const state = Object.assign(
    {
      request: request3.defaults({
        headers: {
          "user-agent": `octokit-auth-oauth-app.js/${VERSION19} ${getUserAgent3()}`
        }
      }),
      clientType: "oauth-app"
    },
  ...
  return Object.assign(auth8.bind(null, state), {
    hook: hook8.bind(null, state)
  });
}

// node_modules/@octokit/oauth-app/node_modules/@octokit/auth-unauthenticated/dist-node/index.js
async function auth9(reason) {
  return {
    type: "unauthenticated",
    reason
  };
...
async function hook9(reason, request4, route, parameters) {
  const endpoint4 = request4.endpoint.merge(
    route,
    parameters
  );
  return request4(endpoint4).catch((error) => {
    if (error.status === 404) {
    ...
    if (error.status === 401) {
      error.message = `Unauthorized. "${endpoint4.method} ${endpoint4.url}" failed most likely due to lack of authentication. Reason: ${reason}`;
      throw error;
    }
...
var createUnauthenticatedAuth = function createUnauthenticatedAuth2(options) {
  ...
  return Object.assign(auth9.bind(null, options.reason), {
    hook: hook9.bind(null, options.reason)
  });
};
...
var OAuthAppOctokit = Octokit.defaults({
  userAgent: `octokit-oauth-app.js/${VERSION20} ${getUserAgent3()}`
});
  ...
  return state.octokit.auth({
    ...
    async factory(options2) {
      const octokit = new state.Octokit({
        authStrategy: createOAuthUserAuth2,
        auth: options2
      });
...
async function resetTokenWithState(state, options) {
  ...
  if (state.clientType === "oauth-app") {
    const response2 = await resetToken2({
      clientType: "oauth-app",
      ...optionsWithDefaults
    });
  ...
  const response = await resetToken2({
    clientType: "github-app",
    ...optionsWithDefaults
  });
...
async function refreshTokenWithState(state, options) {
  ...
  const response = await refreshToken2({
    clientType: "github-app",
    clientId: state.clientId,
    clientSecret: state.clientSecret,
    request: state.octokit.request,
...
async function deleteTokenWithState(state, options) {
  ...
  const response = state.clientType === "oauth-app" ? await deleteToken2({
    clientType: "oauth-app",
    ...optionsWithDefaults
  }) : (
    /* v8 ignore next 4 */
...
async function deleteAuthorizationWithState(state, options) {
  ...
  const response = state.clientType === "oauth-app" ? await deleteAuthorization2({
    clientType: "oauth-app",
    ...optionsWithDefaults
  }) : (
    /* v8 ignore next 4 */
    await deleteAuthorization2({
      clientType: "github-app",
      ...optionsWithDefaults
    })
  );
...
var OAuthApp = class {
  ...
  constructor(options) {
    ...
    const octokit = new Octokit22({
      authStrategy: createOAuthAppAuth2,
      auth: {
...
// node_modules/@octokit/app/node_modules/@octokit/auth-unauthenticated/dist-node/index.js
async function auth10(reason) {
  return {
    type: "unauthenticated",
    reason
  };
...
var REGEX_ABUSE_LIMIT_MESSAGE2 = /\babuse\b/i;
function isAbuseLimitError2(error) {
  if (error.status !== 403) {
    return false;
  }
  return REGEX_ABUSE_LIMIT_MESSAGE2.test(error.message);
}
async function hook10(reason, request4, route, parameters) {
  const endpoint4 = request4.endpoint.merge(
    route,
    parameters
  );
  return request4(endpoint4).catch((error) => {
    ...
    if (isRateLimitError2(error)) {
      error.message = `API rate limit exceeded. This maybe caused by the lack of authentication. Reason: ${reason}`;
      throw error;
    }
    if (isAbuseLimitError2(error)) {
      error.message = `You have triggered an abuse detection mechanism. This maybe caused by the lack of authentication. Reason: ${reason}`;
      throw error;
    }
    if (error.status === 401) {
...
var createUnauthenticatedAuth3 = function createUnauthenticatedAuth22(options) {
  if (!options || !options.reason) {
    throw new Error(
      "[@octokit/auth-unauthenticated] No reason passed to createUnauthenticatedAuth"
    );
  }
  return Object.assign(auth10.bind(null, options.reason), {
    hook: hook10.bind(null, options.reason)
  });
};

// node_modules/@octokit/webhooks/node_modules/@octokit/webhooks-methods/dist-node/index.js
...
function handleEventHandlers(state, webhookName, handler3) {
  if (!state.hooks[webhookName]) {
    state.hooks[webhookName] = [];
  }
  state.hooks[webhookName].push(handler3);
}
function receiverOn(state, webhookNameOrNames, handler3) {
  if (Array.isArray(webhookNameOrNames)) {
    webhookNameOrNames.forEach(
      (webhookName) => receiverOn(state, webhookName, handler3)
    );
    return;
  }
  ...
  handleEventHandlers(state, webhookNameOrNames, handler3);
}
function receiverOnAny(state, handler3) {
  handleEventHandlers(state, "*", handler3);
}
function receiverOnError(state, handler3) {
  handleEventHandlers(state, "error", handler3);
}
function wrapErrorHandler(handler3, error) {
  let returnValue;
  try {
    returnValue = handler3(error);
  } catch (error2) {
...
function receiverHandle(state, event) {
  ...
  if (event instanceof Error) {
    ...
    errorHandlers.forEach((handler3) => wrapErrorHandler(handler3, error));
  ...
  const errors = [];
  const promises = hooks.map((handler3) => {
    let promise = Promise.resolve(event);
    if (state.transform) {
      promise = promise.then(state.transform);
    }
    return promise.then((event2) => {
      return handler3(event2);
...
function removeListener(state, webhookNameOrNames, handler3) {
  if (Array.isArray(webhookNameOrNames)) {
    webhookNameOrNames.forEach(
      (webhookName) => removeListener(state, webhookName, handler3)
    );
    return;
  }
  ...
  for (let i = state.hooks[webhookNameOrNames].length - 1; i >= 0; i--) {
    if (state.hooks[webhookNameOrNames][i] === handler3) {
    ...
    transform: async (event) => {
      if (!("installation" in event.payload) || typeof event.payload.installation !== "object") {
        const octokit2 = new appOctokit.constructor({
          authStrategy: createUnauthenticatedAuth3,
          auth: {
      ...
      const octokit = await appOctokit.auth({
        ...
        installationId,
        factory(auth11) {
          return new auth11.octokit.constructor({
            ...auth11.octokitOptions,
  ...
  return app.octokit.auth({
    ...
    factory(auth11) {
      const options = {
        ...auth11.octokitOptions,
        authStrategy: createAppAuth,
        ...{ auth: { ...auth11, installationId } }
      };
      return new auth11.octokit.constructor(options);
    }
  });
}
...
var Octokit2 = Octokit.plugin(
  ...
  userAgent: `octokit.js/${VERSION23}`,
  throttle: {
    onRateLimit,
...
var GITHUB_TOKEN = process.env.AFU9_GITHUB_TOKEN;
var handler2 = async (event) => {
  ...
  (0, import_node_child_process.execSync)(`git clone https://github.com/${owner}/${repo}.git .`, {
    cwd: workdir,
    stdio: "inherit"
  });
  (0, import_node_child_process.execSync)(`git checkout ${event.targetBranch}`, {
    cwd: workdir,
    stdio: "inherit"
  });
  const branchName = event.patch.branchName;
  (0, import_node_child_process.execSync)(`git checkout -b ${branchName}`, {
    cwd: workdir,
    stdio: "inherit"
  });
  ...
  (0, import_node_child_process.execSync)(`git add .`, { cwd: workdir, stdio: "inherit" });
  (0, import_node_child_process.execSync)(`git commit -m "AFU-9 v0.1: autogenerated patch"`, {
    cwd: workdir,
    stdio: "inherit"
  });
  (0, import_node_child_process.execSync)(`git push origin ${branchName}`, {
    cwd: workdir,
    stdio: "inherit"
  });
  const prTitle = event.issue ? `AFU-9: Fix for Issue #${event.issue.number} (v0.1 stub)` : `AFU-9: Autogenerated Patch (v0.1 stub)`;
  const prBody = (event.issue ? `Bezug auf Issue #${event.issue.number}: ${event.issue.title}

` : `Manuell ausgel\xF6ster AFU-9 v0.1 Job.

`) + `Beschreibung:
${event.patch.description}

Hinweis: v0.1 ist ein Walking Skeleton und generiert nur einfache \xC4nderungen.`;
